...
public final class Node {
    ...
    /** 父目录及其中的条目槽位（用于 flush 时写回元数据），-1 表示未挂载 */
    private NodeDirectory parentDir;
    ...
    public void setStartCluster(long startCluster) {
        this.startCluster = startCluster;
    }
    ...
    /**
     * 记录该节点在父目录中的位置，供 flush 时写回目录条目。
     */
    public void setEntryLocation(NodeDirectory dir, long index) {
        this.parentDir = dir;
        this.entryIndex = index;
    }

    public NodeDirectory getParentDir() {
        return parentDir;
    }
